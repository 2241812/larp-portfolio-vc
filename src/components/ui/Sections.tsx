  ...
  return (
    <div className="relative z-10 flex flex-col w-full pointer-events-none [&>section]:pointer-events-auto">
      ...
      <section id="about me" className="min-h-screen flex items-center justify-end px-8 md:px-24 relative overflow-hidden">
        ...
        <div className="w-full max-w-2xl bg-neutral-950/60 backdrop-blur-xl border border-cyan-900/40 rounded-2xl p-8 md:p-12 relative z-10 shadow-[0_0_40px_rgba(34,211,238,0.05)]">
      ...
      <section id="experience" className="min-h-screen flex items-center justify-start px-8 md:px-24 relative overflow-hidden">
        ...
        <div className="w-full max-w-3xl bg-neutral-950/60 backdrop-blur-xl border border-cyan-900/40 rounded-2xl p-8 md:p-12 relative z-10 shadow-[0_0_40px_rgba(34,211,238,0.05)]">
      ...
      <section id="contact" className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="w-full max-w-xl bg-neutral-950/60 backdrop-blur-xl border border-cyan-900/40 rounded-2xl p-8 md:p-12 relative z-10 shadow-[0_0_40px_rgba(34,211,238,0.05)] text-center">
